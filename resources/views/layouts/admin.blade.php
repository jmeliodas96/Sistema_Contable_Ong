	...
	<section class="full-box cover dashboard-sideBar">
		...
		<div class="full-box dashboard-sideBar-ct">
			...
			<div class="full-box text-uppercase text-center text-titles dashboard-sideBar-title">
				ONG <i class="zmdi zmdi-close btn-menu-dashboard visible-xs"></i>
			</div>
			<!-- SideBar User info -->
			...
			<ul class="list-unstyled full-box dashboard-sideBar-Menu">
				...
				<li>
					...
					<ul class="list-unstyled full-box">
						...
						<li>
							<a href="subject.html"><i class="zmdi zmdi-book zmdi-hc-fw"></i> Tema</a>
						</li>
						<li>
							<a href="section.html"><i class="zmdi zmdi-graduation-cap zmdi-hc-fw"></i> Sección</a>
						</li>
						<li>
				...
				<li>
					...
					<ul class="list-unstyled full-box">
						<li>
							<a href="school.html"><i class="zmdi zmdi-balance zmdi-hc-fw"></i>Datos De ONG</a>
						</li>
					</ul>
				</li>
			</ul>
	...
	<section class="full-box dashboard-contentPage">
		...
		<nav class="full-box dashboard-Navbar">
			<ul class="full-box list-unstyled text-right">
				...
				<li>
					<a href="#!" class="btn-Notifications-area"> <!--boton notificacion en la derecha superior-->
						<i class="zmdi zmdi-notifications-none"></i>
						<span class="badge">10</span> <!--numero de notificaciones-->
					</a>
				</li>
				<li>
					<a href="#!" class="btn-search">  <!--boton buscar en la izquierda superior-->
						<i class="zmdi zmdi-search"></i>
					</a>
				</li>
				<li>
					<a href="#!" class="btn-modal-help"> <!--boton ayuda en la izquierda superior-->
		...
		<div class="container-fluid">
			...
			<p class="lead">Bienvenido revise todas sus notificaciones y tareas pendiente, si desea agregar un nuevo proyecto rellene el formulario, si desea una vista detallada del proyecto, vaya a lista!</p>
		</div> 
